...
export const MODELS: ModelSpec[] = [
  ...
  },
  {
    ...
    refStyle: 'none',
    maxRefs: 0,
    // $2.50 per THOUSAND output megapixels. A 16:9 ~1MP frame is a quarter of a cent.
    tiers: ['1MP'],
    priceUsd: { '1MP': 0.0025 },
    seedable: true,
  ...
  },
  {
    ...
    buildInput: ({ prompt, seed }) => ({
      prompt,
      aspect_ratio: '16:9',
      // Defaults false, pinned anyway — see PROMPT_FIDELITY above.
      prompt_upsampling: false,
      ...(seed !== undefined ? { seed } : {}),
    }),
  },
